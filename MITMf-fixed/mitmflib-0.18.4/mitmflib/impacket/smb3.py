...
from mitmflib.impacket import nmb, ntlm, uuid, crypto, LOG
from mitmflib.impacket.smb3structs import *
from mitmflib.impacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
    STATUS_NO_MORE_FILES, STATUS_PENDING, STATUS_NOT_IMPLEMENTED, ERROR_MESSAGES
from mitmflib.impacket.spnego import SPNEGO_NegTokenInit, TypesMech, SPNEGO_NegTokenResp
...
class SMB3:
    ...
    def kerberosLogin(self, user, password, domain = '', lmhash = '', nthash = '', aesKey='', kdcHost = '', TGT=None, TGS=None):
        ...
        from mitmflib.impacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        from mitmflib.impacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS
        from mitmflib.impacket.krb5 import constants
        from mitmflib.impacket.krb5.types import Principal, KerberosTime, Ticket
...
#            pass
    ...
    def listPath(self, shareName, path, password = None):
        ...
        try:
            ...
            res = ''
            files = []
            from mitmflib.impacket import smb
            while True:
                try:
