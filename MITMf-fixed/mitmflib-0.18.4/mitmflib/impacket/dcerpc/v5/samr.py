...
from mitmflib.impacket.dcerpc.v5.ndr import NDRCALL, NDR, NDRSTRUCT, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniConformantVaryingArray, NDRENUM
from mitmflib.impacket.dcerpc.v5.dtypes import NULL, RPC_UNICODE_STRING, ULONG, USHORT, UCHAR, LARGE_INTEGER, RPC_SID, LONG, STR, \
...
def hSamrChangePasswordUser(dce, userHandle, oldPassword, newPassword):
    ...
    from mitmflib.impacket import crypto, ntlm
