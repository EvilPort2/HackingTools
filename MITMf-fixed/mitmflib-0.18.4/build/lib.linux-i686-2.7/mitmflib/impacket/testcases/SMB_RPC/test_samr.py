...
from mitmflib.impacket.dcerpc.v5 import samr, epm
from mitmflib.impacket.dcerpc.v5 import dtypes
from mitmflib.impacket import nt_errors, ntlm
...
class SAMRTests(unittest.TestCase):
    ...
    def test_SamrChangePasswordUser(self):
        ...
        from mitmflib.impacket import crypto
