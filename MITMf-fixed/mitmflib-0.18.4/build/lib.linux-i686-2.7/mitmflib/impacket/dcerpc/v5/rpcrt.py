...
from mitmflib.impacket import ntlm, LOG
from mitmflib.impacket.structure import Structure,pack,unpack
from mitmflib.impacket.krb5 import kerberosv5, gssapi
from mitmflib.impacket import uuid
from mitmflib.impacket.uuid import uuidtup_to_bin, generate, stringver_to_bin, bin_to_uuidtup
from mitmflib.impacket.dcerpc.v5.dtypes import UCHAR, ULONG, USHORT
from mitmflib.impacket.dcerpc.v5.ndr import NDRSTRUCT
    ...
    def bind(self, iface_uuid, alter = 0, bogus_binds = 0, transfer_syntax = ('8a885d04-1ceb-11c9-9fe8-08002b104860', '2.0')):
        ...
        if self.__auth_level != RPC_C_AUTHN_LEVEL_NONE:
            ...
            if self.__auth_type == RPC_C_AUTHN_WINNT:
                ...
                from mitmflib.impacket.dcerpc.v5 import nrpc
