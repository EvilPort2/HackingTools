...
from mitmflib.impacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from mitmflib.impacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG
from mitmflib.impacket import system_errors, nt_errors
from mitmflib.impacket.uuid import uuidtup_to_bin
from mitmflib.impacket.dcerpc.v5.enum import Enum
from mitmflib.impacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from mitmflib.impacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from mitmflib.impacket.dcerpc.v5.rpcrt import DCERPCException
from mitmflib.impacket.structure import Structure
from mitmflib.impacket import ntlm, crypto, LOG
import hmac, hashlib
try:
...
# 2.2.1.1.2 STRING
from mitmflib.impacket.dcerpc.v5.lsad import STRING
...
from mitmflib.impacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
