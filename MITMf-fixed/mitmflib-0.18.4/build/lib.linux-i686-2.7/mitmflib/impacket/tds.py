...
from mitmflib.impacket import ntlm, uuid, LOG
...
class MSSQL:
    ...
    def kerberosLogin(self, database, username, password='', domain='', hashes=None, aesKey='', kdcHost=None, TGT=None, TGS=None, useCache=True):
        ...
        from mitmflib.impacket.spnego import SPNEGO_NegTokenInit, TypesMech
        # Importing down here so pyasn1 is not required if kerberos is not used.
        from mitmflib.impacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        from mitmflib.impacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS, KerberosError
