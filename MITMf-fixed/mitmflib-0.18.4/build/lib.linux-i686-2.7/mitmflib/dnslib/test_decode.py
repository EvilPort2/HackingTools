...
"""
    ...
    Reads test files from mitmflib.dnslib/test (by default) containing 
...
from mitmflib.dnslib.dns import DNSRecord
from mitmflib.dnslib.digparser import DigParser
